...
import com.example.xingzhi.holographicteaching.ui.fragment.PartnerOrderFragment;
...
public class PartnerOrderActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.titleLayout.tvTitle.setText("【用户昵称】的交易详情");
        initFragments();
        initMagicIndicator();
    ...
    private void initFragments() {
        for (int i = 0; i < CHANNELS.length; i++) {
            mFragments.add(new PartnerOrderFragment());
        }
