...
import com.example.xingzhi.holographicteaching.databinding.ActivityWithdrawBindBinding;
...
public class WithdrawBindActivity extends AppCompatActivity implements View.OnClickListener {

    private ActivityWithdrawBindBinding binding;
    private static final String[] CHANNELS = new String[]{"银行卡", "支付宝"};
    private List<Fragment> mFragments = new ArrayList<Fragment>();
    private FragmentContainerHelper mFragmentContainerHelper = new FragmentContainerHelper();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_withdraw_bind);
        binding.titleLayout.tvTitle.setText("提现方式绑定");
...
//        }
        mFragments.add(new BankCardFragment());
        mFragments.add(new BindAlipayFragment());
