...
import com.example.xingzhi.holographicteaching.adpter.PartnerOrderAdapter;
...
public class PartnerOrderFragment extends Fragment {
    ...
    private PartnerOrderAdapter adapter;
...
//        itemListModel = ViewModelProviders.of(getActivity()).get(ItemListModel.class);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new PartnerOrderAdapter(getContext());
